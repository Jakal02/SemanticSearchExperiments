...
ESDep = Annotated[Elasticsearch, Depends(get_es_client)]
...
@app.post("/post/")
def create_post(post_data: PostCreate, db:SessionDep, client: ESDep):
...
@app.delete("/post/{id}/")
def delete_post(id: int, db: SessionDep, client: ESDep):
...
@app.get("/sem_search/")
def semantic_search(query: str, client: ESDep):
